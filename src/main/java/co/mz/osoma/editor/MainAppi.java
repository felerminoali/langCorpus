...
import co.mz.osoma.editor.controlador.EditDistanceDialogController;
import co.mz.osoma.editor.controlador.LoadFileDialogController;
import co.mz.osoma.editor.controlador.MarkovController;
import co.mz.osoma.editor.controlador.TextProController;
...
public class MainAppi extends Application {
...
//            rootLayout = (BorderPane) loader.load();
            ...
            loader.setLocation(MainAppi.class.getResource("vista/RootLayout2.fxml"));
            rootLayout = (BorderPane) loader.load();
    ...
    public void showTextProApp() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("vista/TextAppLayout.fxml"));
    ...
    public void showLoadFileDialog(AutoSpellingTextArea ta) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(MainAppi.class.getResource("vista/LoadFileLayout.fxml"));
    ...
    public void showEditDistanceDialog(String selectedText) {
        try {
            // Load the fxml file and create a new stage for the popup
            FXMLLoader loader = new FXMLLoader(MainAppi.class.getResource("vista/EditDistanceLayout.fxml"));
            VBox page = (VBox) loader.load();
            Stage dialogStage = new Stage();
    ...
    public void showMarkovDialog(MarkovTextGenerator mtg) {
        try {
            // Load the fxml file and create a new stage for the popup
            FXMLLoader loader = new FXMLLoader(MainAppi.class.getResource("vista/MarkovLayout.fxml"));
